...
GREENNAV.settings = {};
GREENNAV.settings.templates = {};

GREENNAV.settings.init = function initSettings (settings, goButtonText, cb) {
	...
	for (var settingName in settings) {
		if (!settings[settingName].type || settings[settingName].category) {
			div.appendChild(GREENNAV.settings.returnDivOfSetting(settings[settingName], settingName, cb, "settings."));
		} else {
			main.appendChild(GREENNAV.settings.returnDivOfSetting(settings[settingName], settingName, cb, "settings."));
		}
	}
	return div;
};

GREENNAV.settings.returnDivOfSetting = function returnDivOfSetting (settingOptions, settingName, cb, parent) {
	...
	if (!settingOptions.type || settingOptions.category) {
		...
		for (var settingNameKey in settingOptions) {
			...
			settings.appendChild(GREENNAV.settings.returnDivOfSetting(settingOptions[settingNameKey], settingNameKey, cb, (parent || "") + settingName + "."));
		}
	} else {
		if (GREENNAV.settings.templates[settingOptions.type]) {
			GREENNAV.settings.templates[settingOptions.type](settingOptions, settingName, cb, parent, settings);
		} else {
...
GREENNAV.settings.templates.switch = function (settingOptions, settingName, cb, parent, settingsDiv) {
...
GREENNAV.settings.templates.array = function (settingOptions, settingName, cb, parent, settingsDiv) {
	settingsDiv.classList.add("setting");
